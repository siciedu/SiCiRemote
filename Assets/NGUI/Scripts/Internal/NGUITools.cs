...
static public class NGUITools
{
	...
	static void Activate (Transform t, bool recusive)
	{
	...
	static void Deactivate(Transform t, bool recusive)
	{
#if UNITY_3_5
		for (int i = 0, imax = t.GetChildCount(); i < imax; ++i)
		{
	...
	static public void SetActive(GameObject go, bool state, bool recusive = false)
	{
		if (state)
		{
			Activate(go.transform, recusive);
		}
		else
		{
			Deactivate(go.transform, recusive);
		}
	}
